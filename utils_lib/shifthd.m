...
if plotit==1
    ...
    set(gca,'FontSize',14,'XLim', [-1.5, 6]) %[min(xd)-ext max(xd)+ext])
    box on
    xlabel('Group-based t-distribution quantiles','FontSize',16)
    ylabel('Group-based - individualized quantiles','FontSize',16)
